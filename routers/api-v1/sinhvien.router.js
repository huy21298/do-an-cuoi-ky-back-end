...
const { suaThongTin ,CapNhatAvatar, LoadThongTinSinhVien ,quenMatKhau, doiMatKhau} = require("../../controllers/sinhvien.controller");
...
router.post("/doi-mat-khau", doiMatKhau);
